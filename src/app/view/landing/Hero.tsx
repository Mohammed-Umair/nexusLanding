        ...
        <>
          <Flex>
            <Box left="0rem" top="0rem">
              <Image src={IMAGE_COLLECTIONS.landingMain} width={isMobile?"100%":"70%"}    />
            </Box>
            <Box left={isMobile?"0rem":"4rem"} top="0rem">
              <Image src={IMAGE_COLLECTIONS.landingsecondary1} width={isMobile?"100%":"70%"} style={{
          ...
          <Box className="hero-centered-element">
            <Flex width="100%" style={{ marginLeft: "1rem" }}>
              <Box position="relative" zIndex={100}>
                {!isTab && (
                  <Typography
                    fontSize={isTab ? "60px" : "90px"}
                    fontFamily="SEN bold"
                    color={DEFAULT_COLORS.White}
                    lineHeight={"80px"}
                    style={{ marginLeft: isTab ? "0rem" : "3rem" }}
                  >
                    Leading <br /> Launches.
                  </Typography>
                )}
                ...
                <Box mt={isTab ? "1rem" : "10rem"} mr="12rem">
                  <Flex>
                    ...
                    <Button borderRadius="25px" padding=".6rem 1.2rem">
                      ...
                      <a
                        href="https://twitter.com/NexusLaunchpad"
                        target="_blank"
                      >
                        <Box
                          sx={{
