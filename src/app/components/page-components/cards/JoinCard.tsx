...
const JoinCard = ({ image, hoverImage, title, description }: JoinCardProps) => {
    ...
    return (
        ...
        <Container background={DEFAULT_COLORS.black} borderRadius='30px' padding='1rem 1.5rem' ref={boxRef} onMouseOver={onMouse} onMouseLeave={offMouse} height={'4.5rem'} fullWidth maxWidth="265px" style={{ margin: '5px' }} hover={true}>
